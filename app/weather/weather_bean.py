class WeatherBean:
    def __init__(self, active=True, email_receiver=None, reminder_time=[], remind_mode='all',
                 longitude=None,
                 latitude=None,
                 rain_have=False,
                 rain_desc=None, temperature_highest_scop=None,
                 temperature_lowest_scop=None,
